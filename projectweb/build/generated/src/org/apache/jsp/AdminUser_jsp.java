...
public final class AdminUser_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 for (int i = 1; i < list.getListUser().size(); i++) {
      ...
      out.write("                                    <td>");
      out.print( list.getListUser().get(i).getUid());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( list.getListUser().get(i).getUsername());
      out.write("</td>\n");
      out.write("                                    <td>");
      out.print( list.getListUser().get(i).getPermission());
      out.write("</td>\n");
      out.write("                                    <td class=\"center\">4</td>\n");
      out.write("                                    <td class=\"center\">\n");
      out.write("                                        <a  class=\"btn btn-info btn-circle\" href=\"\"><i class=\"fa fa-check\"></i>\n");
      out.write("                                        </a>\n");
      out.write("                                        <a  class=\"btn btn-warning btn-circle\" href=\"\"><i class=\"fa fa-times\"></i>\n");
      out.write("                                        </a>\n");
      out.write("                                    </td>\n");
      out.write("                                </tr>\n");
      out.write("                                ");
